...
products = Product.create([{ name: 'cone', price: 2.25 }, { name: 'shake', price: 4.99 }, { name: 'float', price: 3.50 }])
...
discounts = Discount.create([{ product_id: 1, discount: 0.8 }, { product_id: 2, discount: 0.8 }])